---
name: workers-deploy
description: prottype の Cloudflare Workers 多環境デプロイ手順。 develop / staging / production / preview（PR 単位）、GitHub Actions CI、 wrangler.jsonc env 設定、D1・シークレットの環境分離、Workers Builds 設定時に使う。
---
