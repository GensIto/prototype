...
description: '新機能のテストケース作成。Issue・受入条件・ソースコード（app/modules, routes, db/schema）を 起点に Vitest 単体テストと手動テストケース CSV を設計する。7人のQAペルソナを適用。 出典: https://zenn.dev/nexta_/articles/be13a2395a5d2a'
---
