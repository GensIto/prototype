...
description: >-
  prottype 相当の Cloudflare Workers フルスタックプロジェクトを空ディレクトリから0セットアップする。
  Hono, Inertia, React 19, D1, Drizzle, Better Auth, rulesync, QA skills, 多環境デプロイを含む。
  新規プロジェクト立ち上げ、または「skills だけで再現できるか」の検証時に使う。
---
